            ...
            <div class="divide-y divide-gray-200">
              <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div class="flex flex-col">
                  ...
                  <div v-loading="loading" element-loading-text="Cargando cancha..." element-loading-background="rgba(0, 0, 0, 0.8)"
    style="width: 100%"> 
          <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
              ...
              <div class="pt-4 flex items-center space-x-4">
                <button @click="cancelarReserva" class="flex justify-center items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
                ...
                <button @click="crearReserva" class="bg-custom-green flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Crear Reserva</button>
              </div>
            </div>
          </div>
        </div>
